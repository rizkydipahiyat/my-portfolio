...
const Contact = () => {
  ...
  return (
    <div
      className={
        theme === "light"
          ? "bg-zinc-800 text-slate-100 container mx-auto w-full px-3 py-5 md:container md:px-10 md:py-5 h-[500px] md:h-[600px]"
          : "bg-zinc-100 text-slate-800 container mx-auto w-full px-3 py-5 md:container md:px-10 md:py-5 h-[500px] md:h-[600px]"
      }>
