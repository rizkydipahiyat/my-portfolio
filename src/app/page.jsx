    ...
    <>
      <Head>
        ...
        <meta
          name="description"
          content={
            "A recent Computer Science graduate with a keen interest in web development"
          }
        />
        ...
        <meta
          ...
          content="A recent Computer Science graduate with a keen interest in web development"
        />
        <meta
          property="og:image"
          ...
          <div className="md:2/3 md:mt-32 md:mb-40 mt-5">
            <div className="md:px-5">
              <span className="md:text-2xl text-md font-light text-justify">
                A recent Computer Science graduate with a keen interest in web
                development
              </span>
            </div>
          </div>
